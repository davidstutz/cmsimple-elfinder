...
/**
 * All configuration is done using session.
...
$opts = array(
	'root'            => $_SESSION['elfinder']['root'],                       // path to root directory
	'URL'             => 'http://' . $_SESSION['elfinder']['url'], // root directory URL
	...
	'imgLib'       => $_SESSION['elfinder']['images_library'],       // image manipulation library (imagick, mogrify, gd)
