...
<head>
	...
	<link rel="stylesheet" href="../jquery/css/smoothness/jquery-ui-1.8.13.custom.css" type="text/css" media="screen" title="no title" charset="utf-8">
	<link rel="stylesheet" href="../elfinder/css/elfinder.css" type="text/css" media="screen" title="no title" charset="utf-8">

	<script src="../jquery/js/js/jquery-1.6.1.min.js" type="text/javascript" charset="utf-8"></script>
	<script src="../jquery/js/jquery-ui-1.8.13.custom.min.js" type="text/javascript" charset="utf-8"></script>
